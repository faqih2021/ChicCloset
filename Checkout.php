...
<body>
 ...
 -->
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($cart_details_result->num_rows > 0) {
                                        while ($cart_details_rows = $cart_details_result->fetch_assoc()) {
                                            ...
                                            echo "<tr><td><div class='price'>Rp. $item_price</div><td></tr></table>";
                                        }
                                    }
                                }
                            }
                ...
                <div class="left-side-bottom">
                    ...
                    <div class="tot-value">
                        <span style="float: right;">Rp.12.000</span><br>
                        <span style="float: right;">Rp.<?php echo $total + 12000 ?>.0</span>
                    </div>
                </div>
            ...
            <div class="right-side">
                <div class="billing-details">
                    ...
                    <div class="address-top">
                        ...
                        <input type="text" name="address1" placeholder="City">
                    </div>
